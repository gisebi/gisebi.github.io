...
$authors = array(
    1 => 'Machine in the walls',
    2 => 'Running in the 80s RETROWAVE BOOTLEG',
    3 => 'Deja Vu'
);
...
if (isset($_GET['mapname']))
    $map = '<br>Ihre Destination: '.$_GET['mapname'];

if (isset($_GET['steamid'])) {
    $data = 'http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=F1345B9AE007E93CE656C76B6B81E29C&steamids='.$_GET['steamid'];
...
<body> 
    ...
    <div class="container">
        <div class="jumbotron" style="margin-top: 50px;">
            ...
            <h1 id="title" class="bigEntrance" style="font-size: 50px;">SEBIS TTT SERVER</h1>
            <p class="lead">
                Willkommen auf meinem Server.<br>
                <small>
                    <ul style="line-height: 1.6;">
                        <li>Hey.</li>
                        <li>Anime ist Scheiße.</li>
                        <li>Wenn du tot bist, dann musst du still sein.</li>
                        <li>Genieß einfach die Musik während du wartest!</li>
						<li>YEET</li>
                    </ul>
                </small>
            </p>
    ...
    <div style="position: absolute;bottom: 0px;left: 20px;font-size: 12px;min-width: 260px;" class="well well-sm">
        ...
        Hallo, <b><?php echo $plname ?></b><?php echo $map ?><br>
        Musiktitel: "<?php echo $authors[$r];?>"
    </div>
